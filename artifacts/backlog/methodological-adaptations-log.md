...
| Trust Boundaries definition | 🔄 **Adapted → Threat Scenarios per Scenario**| 4 Trust Boundaries mapped: Governança, Curadoria, Colaboração Aberta, Armazenamento/Consumo |
